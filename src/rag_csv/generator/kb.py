...
def main():
    ...
    cfg = KBGeneratorConfig(
        ...
        #tickets_csv=Path(config.GeneratorConfig().output_csv_path+"/synthetic_incidents_llm_phi4-mini:latest.csv"),
        tickets_csv=Path(config.GeneratorConfig().output_csv_path+"/synthetic_incidents_llm.csv"),
        output_kb_csv=Path(config.GeneratorConfig().output_csv_path+"/kb_articles_llm.csv"),
        output_tickets_with_kb_csv=Path(config.GeneratorConfig().output_csv_path+"/synthetic_incidents_with_kb.csv"),
